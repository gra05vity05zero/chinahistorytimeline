...
export default function sitemap() {
  ...
  const staticRoutes = [
    ...
    { url: `${SITE_URL}/china-capitals`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
    { url: `${SITE_URL}/silk-road`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
    { url: `${SITE_URL}/great-wall`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
    { url: `${SITE_URL}/four-inventions`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
